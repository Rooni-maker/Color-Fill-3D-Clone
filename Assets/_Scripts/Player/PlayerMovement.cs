...
{
    [Title("PLAYER MOVEMENT", null, titleAlignment: TitleAlignments.Centered)]
    [DisplayAsString]
    [SerializeField] bool _isMoving  = false;
    [SerializeField] float moveSpeed = 10f;

    [DisplayAsString] Vector3 _moveVector = Vector3.zero;
    ...
    public void Restart()
    {
        ...
        _rigidbody.velocity = _startPos3 = _targetPos = _moveVector= Vector3.zero;
